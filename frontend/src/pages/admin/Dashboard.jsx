        ...
        <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="text-center md:text-left space-y-1 flex-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-4">
              <h1 
                className='px-[10px] py-[10px] border-2 bg-black border-black text-white rounded-[10px] text-[15px] font-light flex items-center justify-center gap-2 cursor-pointer w-full sm:w-auto'
                onClick={() => navigate("/courses")}
              >
                Create Courses
              </h1>

              {/* New Button: View Enrolled Students */}
              <h1 
                className='px-[10px] py-[10px] border-2 bg-white border-black text-black rounded-[10px] text-[15px] font-light flex items-center justify-center gap-2 cursor-pointer w-full sm:w-auto hover:bg-gray-100 transition'
